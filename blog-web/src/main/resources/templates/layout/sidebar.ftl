    ...
    <div class="sidebar-module">
        ...
        <ul class="ul-default site-info">
            <@zhydTag method="siteInfo">
                ...
                <li> <i class="fa fa-vine fa-fw"></i>  系统版本：<a href="https://github.com/faceman0814/blog" rel="nofollow" target="_blank" style="color: #4286ca;font-weight: 600;">${appInfo.version!}</a></li>
            </@zhydTag>
        </ul>
    </div>
    <#-- 广告位 -->
